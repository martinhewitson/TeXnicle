// Created by iWeb 3.0.3 local-build-20110603
...
adjustLineHeightIfTooBig('id1');adjustFontSizeIfTooBig('id1');Widget.onload();fixupAllIEPNGBGs();fixAllIEPNGs('Media/transparent.gif');IMpreload('Home_files','shapeimage_2','0');IMpreload('Home_files','shapeimage_3','0');IMpreload('Home_files','shapeimage_4','0');IMpreload('Home_files','shapeimage_5','0');applyEffects()}
