                           ...
                           CFStringRef pathToFile) 
{
  ...
  if (metadata != nil) {
    ...
    NSLog(@"Importer metadata %@", metadata);
    return TRUE;
  }
  return FALSE;
}
...
//    Boolean ok = FALSE;
//    
//    if ([(NSString *)contentTypeUTI isEqualToString:@"com.bobsoft.TeXnicle.texnicle"]) {
//    
...
//			
//			NSObject *contentToIndex = [metadata objectForKey: @"name"];
